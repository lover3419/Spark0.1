...
gg.editAll("9999", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("🎯 AimBot 100m activated")
gg.setRanges(gg.REGION_C_DATA)
end
...
function Backuponly()
  DMG =gg.multiChoice({
    "🐰Damage fix all weapons🐰",
    "🐰Damage fix M4,Scar,Akm🐰",
    "🐰Damage fix M4🐰",
    "🐰Damage fix Akm🐰",
    "🐰Damage fix Scarl🐰",
    "🐰Damage fix Dp28🐰",
